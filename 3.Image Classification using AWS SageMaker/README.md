...
I choose resnet50 as it is good for image classification
types the hyperparameter:
...
**TODO**: Give an overview of how you performed model debugging and profiling in Sagemaker
 Import Amazon SageMaker Debugger client library
 In the train() function, add the SMDebug hook for PyTorch with TRAIN mode
### Results
**TODO**: What are the results/insights did you get by profiling/debugging your model?
I could find the rule parameters and numeber of datapoints
